...
namespace Sentencepiece {
...
#endif
    {
        ...
        public bool Equals(TrainerSpec other) {
            ...
            if (!input_.Equals(other.input_))
                return false;
            if (InputFormat != other.InputFormat)
                return false;
            if (ModelPrefix != other.ModelPrefix)
                return false;
            if (ModelType != other.ModelType)
                return false;
            if (VocabSize != other.VocabSize)
                return false;
            if (!acceptLanguage_.Equals(other.acceptLanguage_))
                return false;
            if (SelfTestSampleSize != other.SelfTestSampleSize)
                return false;
            if (EnableDifferentialPrivacy != other.EnableDifferentialPrivacy)
                return false;
            if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(DifferentialPrivacyNoiseLevel, other.DifferentialPrivacyNoiseLevel))
                return false;
            if (DifferentialPrivacyClippingThreshold != other.DifferentialPrivacyClippingThreshold)
                return false;
            if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(CharacterCoverage, other.CharacterCoverage))
                return false;
            if (InputSentenceSize != other.InputSentenceSize)
                return false;
            if (ShuffleInputSentence != other.ShuffleInputSentence)
                return false;
            if (MiningSentenceSize != other.MiningSentenceSize)
                return false;
            if (TrainingSentenceSize != other.TrainingSentenceSize)
                return false;
            if (SeedSentencepieceSize != other.SeedSentencepieceSize)
                return false;
            if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(ShrinkingFactor, other.ShrinkingFactor))
                return false;
            if (MaxSentenceLength != other.MaxSentenceLength)
                return false;
            if (NumThreads != other.NumThreads)
                return false;
            if (NumSubIterations != other.NumSubIterations)
                return false;
            if (MaxSentencepieceLength != other.MaxSentencepieceLength)
                return false;
            if (SplitByUnicodeScript != other.SplitByUnicodeScript)
                return false;
            if (SplitByNumber != other.SplitByNumber)
                return false;
            if (SplitByWhitespace != other.SplitByWhitespace)
                return false;
            if (TreatWhitespaceAsSuffix != other.TreatWhitespaceAsSuffix)
                return false;
            if (AllowWhitespaceOnlyPieces != other.AllowWhitespaceOnlyPieces)
                return false;
            if (SplitDigits != other.SplitDigits)
                return false;
            if (PretokenizationDelimiter != other.PretokenizationDelimiter)
                return false;
            if (!controlSymbols_.Equals(other.controlSymbols_))
                return false;
            if (!userDefinedSymbols_.Equals(other.userDefinedSymbols_))
                return false;
            if (RequiredChars != other.RequiredChars)
                return false;
            if (ByteFallback != other.ByteFallback)
                return false;
            if (VocabularyOutputPieceScore != other.VocabularyOutputPieceScore)
                return false;
            if (HardVocabLimit != other.HardVocabLimit)
                return false;
            if (UseAllVocab != other.UseAllVocab)
                return false;
            if (UnkId != other.UnkId)
                return false;
            if (BosId != other.BosId)
                return false;
            if (EosId != other.EosId)
                return false;
            if (PadId != other.PadId)
                return false;
            if (UnkPiece != other.UnkPiece)
                return false;
            if (BosPiece != other.BosPiece)
                return false;
            if (EosPiece != other.EosPiece)
                return false;
            if (PadPiece != other.PadPiece)
                return false;
            if (UnkSurface != other.UnkSurface)
                return false;
            if (TrainExtremelyLargeCorpus != other.TrainExtremelyLargeCorpus)
                return false;
            if (SeedSentencepiecesFile != other.SeedSentencepiecesFile)
                return false;
        ...
        public override int GetHashCode() {
            ...
            if (HasEnableDifferentialPrivacy)
                hash ^= EnableDifferentialPrivacy.GetHashCode();
            if (HasDifferentialPrivacyNoiseLevel)
                hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(DifferentialPrivacyNoiseLevel);
            if (HasDifferentialPrivacyClippingThreshold)
                hash ^= DifferentialPrivacyClippingThreshold.GetHashCode();
            if (HasCharacterCoverage)
                hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(CharacterCoverage);
            ...
            if (HasMiningSentenceSize)
                hash ^= MiningSentenceSize.GetHashCode();
            if (HasTrainingSentenceSize)
                hash ^= TrainingSentenceSize.GetHashCode();
            if (HasSeedSentencepieceSize)
                hash ^= SeedSentencepieceSize.GetHashCode();
            if (HasShrinkingFactor)
                hash ^= pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.GetHashCode(ShrinkingFactor);
            if (HasMaxSentenceLength)
                hash ^= MaxSentenceLength.GetHashCode();
            if (HasNumThreads)
                hash ^= NumThreads.GetHashCode();
            if (HasNumSubIterations)
                hash ^= NumSubIterations.GetHashCode();
            if (HasMaxSentencepieceLength)
                hash ^= MaxSentencepieceLength.GetHashCode();
            if (HasSplitByUnicodeScript)
                hash ^= SplitByUnicodeScript.GetHashCode();
            if (HasSplitByNumber)
                hash ^= SplitByNumber.GetHashCode();
            if (HasSplitByWhitespace)
                hash ^= SplitByWhitespace.GetHashCode();
            if (HasTreatWhitespaceAsSuffix)
                hash ^= TreatWhitespaceAsSuffix.GetHashCode();
            if (HasAllowWhitespaceOnlyPieces)
                hash ^= AllowWhitespaceOnlyPieces.GetHashCode();
            if (HasSplitDigits)
                hash ^= SplitDigits.GetHashCode();
            if (HasPretokenizationDelimiter)
                hash ^= PretokenizationDelimiter.GetHashCode();
            hash ^= controlSymbols_.GetHashCode();
            hash ^= userDefinedSymbols_.GetHashCode();
            if (HasRequiredChars)
                hash ^= RequiredChars.GetHashCode();
            if (HasByteFallback)
                hash ^= ByteFallback.GetHashCode();
            ...
            if (HasTrainExtremelyLargeCorpus)
                hash ^= TrainExtremelyLargeCorpus.GetHashCode();
...
#endif
    {
        ...
        public bool Equals(NormalizerSpec other) {
            ...
            if (Name != other.Name)
                return false;
            if (PrecompiledCharsmap != other.PrecompiledCharsmap)
                return false;
            if (AddDummyPrefix != other.AddDummyPrefix)
                return false;
            if (RemoveExtraWhitespaces != other.RemoveExtraWhitespaces)
                return false;
            if (EscapeWhitespaces != other.EscapeWhitespaces)
                return false;
            if (NormalizationRuleTsv != other.NormalizationRuleTsv)
                return false;
            if (!Equals(_extensions, other._extensions)) {
                return false;
            }
...
#endif
    {
        ...
        public bool Equals(SelfTestData other) {
            ...
            if (!samples_.Equals(other.samples_))
                return false;
            if (!Equals(_extensions, other._extensions)) {
                return false;
            }
...
#endif
    {
        ...
        public bool Equals(ModelProto other) {
            ...
            if (!pieces_.Equals(other.pieces_))
                return false;
            if (!object.Equals(TrainerSpec, other.TrainerSpec))
                return false;
            if (!object.Equals(NormalizerSpec, other.NormalizerSpec))
                return false;
            if (!object.Equals(SelfTestData, other.SelfTestData))
                return false;
            if (!object.Equals(DenormalizerSpec, other.DenormalizerSpec))
                return false;
            if (!Equals(_extensions, other._extensions)) {
                return false;
            }
        ...
        public override int GetHashCode() {
            ...
            if (trainerSpec_ != null)
                hash ^= TrainerSpec.GetHashCode();
            if (normalizerSpec_ != null)
                hash ^= NormalizerSpec.GetHashCode();
            if (selfTestData_ != null)
                hash ^= SelfTestData.GetHashCode();
            if (denormalizerSpec_ != null)
                hash ^= DenormalizerSpec.GetHashCode();
            if (_extensions != null) {
                hash ^= _extensions.GetHashCode();
            }
            if (_unknownFields != null) {
...
#endif
            {
                ...
                public bool Equals(SentencePiece other) {
                    ...
                    if (Piece != other.Piece)
                        return false;
                    if (!pbc::ProtobufEqualityComparers.BitwiseSingleEqualityComparer.Equals(Score, other.Score))
                        return false;
                    if (Type != other.Type)
                        return false;
                    if (!Equals(_extensions, other._extensions)) {
